...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-body">
      <section className="pt-8 pb-xl md:pb-xxl container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 max-w-6xl mx-auto">
          <div className="lg:col-span-2">
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-primary mb-6">
              Start your journey
            </h1>
            <p className="text-lg text-secondary leading-relaxed mb-10">
              Whether you're curious to learn more or have specific questions
              about signing up for one of our offerings, we'd love to hear from
              you.
            </p>
