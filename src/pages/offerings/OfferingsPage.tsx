  ...
  return (
    <div className="min-h-screen bg-body">
      <section className="pt-8 pb-xl md:pb-xxl container-wide">
        <div className="text-center max-w-2xl mx-auto mb-10 lg:mb-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="space-y-1 mb-7 text-sm text-secondary">
                <p>Seasonal Programs</p>
                <p>Private Sessions</p>
                <p>Live Events & Retreats</p>
              </div>
