      ...
      <div style={{ background: '#faf9f6', borderRadius: 20, width: '100%', maxWidth: 520, maxHeight: '92vh', overflowY: 'auto', position: 'relative', boxShadow: '0 32px 80px rgba(0,0,0,0.28)' }}>
        ...
        <div style={{ background: '#2d3d35', borderRadius: '20px 20px 0 0', padding: '24px 28px', color: '#fff' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div>
              <h3 style={{ margin: '0 0 4px', fontSize: 20, fontWeight: 700, color: '#fff' }}>The Soul — 4-Session Series</h3>
              <p style={{ margin: 0, fontSize: 13, color: '#a8c4b2' }}>4 private sessions · 35 min each · Virtual via Zoom</p>
            </div>
            <div style={{ textAlign: 'right', flexShrink: 0, marginLeft: 16 }}>
              <p style={{ margin: 0, fontSize: 26, fontWeight: 800, letterSpacing: '-0.02em', color: '#fff' }}>$340</p>
          ...
          {step === 'payment' && (
            <div>
              ...
              <div style={{ background: '#f5f3ef', borderRadius: 10, padding: '12px 16px', marginBottom: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 13 }}>
                <span style={{ color: '#5a5650' }}>The Soul — 4-Session Series</span>
                <span style={{ fontWeight: 700, color: '#2d3d35', fontSize: 15 }}>$340</span>
              </div>
          ...
          {step === 'success' && (
            <div style={{ textAlign: 'center', padding: '8px 0 16px' }}>
              ...
              <div style={{ background: '#f1ede7', borderRadius: 12, padding: '16px', textAlign: 'left', marginBottom: 24 }}>
                <p style={{ margin: '0 0 6px', fontWeight: 700, fontSize: 13, color: '#2d3d35' }}>The Soul — 4-Session Series</p>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px 80px' }}>
        <div style={{ marginTop: -28, position: 'relative', zIndex: 10, background: '#fff', borderRadius: 20, boxShadow: '0 4px 32px rgba(18,30,24,0.10)', overflow: 'hidden', marginBottom: 56, display: 'grid', gridTemplateColumns: '1fr auto' }}>
          <div style={{ padding: '28px 32px' }}>
            ...
            <h2 style={{ margin: '0 0 8px', fontSize: 22, fontWeight: 800, color: '#1e2b25' }}>The Soul</h2>
