...
<section id="overview" className="relative overflow-hidden">
  <div className="absolute inset-0 h-full lg:h-96">
    <img
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-10">
    ...
    <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
      ...
      <div className="max-w-3xl">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          <span className="text-sage-400 font-medium tracking-widest uppercase text-xs sm:text-sm">
            Flow Series
          </span>
        </div>
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white mb-3 sm:mb-4 leading-tight">
          Spring 2026
          <span className="block text-sage-400 text-xl sm:text-3xl lg:text-4xl font-semibold mt-1">
            "Career & Expansion"
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4 text-sm">
          <span className="flex items-center gap-1.5 text-white/80">
            <Calendar className="w-4 h-4" /> March 22 - May 3, 2026
          </span>

          <span className="flex items-center gap-1.5 text-white/80">
            <Clock className="w-4 h-4" /> Sundays, 4-6pm PST
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:items-end gap-4">
        ...
        <div>
          <Link
            ...
            className="group flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 bg-sage-600 text-white rounded-xl font-bold text-base hover:bg-sage-700 transition-colors shadow-sm shadow-sage-900/10"
          >
            Enroll Now — $1200
            <ArrowRight className="w-5 h-5 group-hover:translate-x-0.5 transition-transform" />
          </Link>

          <p className="text-center lg:text-right text-xs text-slate-300 mt-3">
