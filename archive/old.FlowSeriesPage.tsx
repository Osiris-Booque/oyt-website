        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-8 sm:pb-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4 text-sm">
              ...
              <span className="flex items-center gap-1.5 text-amber-300 font-medium"><Users className="w-4 h-4" /> 8 spots remaining</span>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="lg:sticky lg:top-24">
              <div className="bg-white rounded-3xl border border-stone-200 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-stone-100">
                  ...
                  <div className="mt-3 flex items-center gap-2 text-amber-600 text-sm font-semibold">
